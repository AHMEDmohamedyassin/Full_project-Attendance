    ...
    <div className='contain'> 
        <div className='bg-background lg:px-10 px-4 py-10 mb-10 lg:w-2/4'>
            ...
            <div className='flex sm:flex-nowrap flex-wrap items-center gap-4 border-b-[1px] border-gray-200 py-10'>
                ...
                <a className='text-mainblue sm:text-xl text-lg hover:text-mainBlue' style={{wordWrap:'anywhere'}} href='mailto:ahmedmohamed982025@outlook.com'>ahmedmohamed@outlook.com</a>
            </div>
            {/* mobile phone */}
